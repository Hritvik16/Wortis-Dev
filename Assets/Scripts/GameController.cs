...
//     {
//         while (!currentLetterCube.activeInHierarchy || !currentLetterCube.GetComponent<LetterCubeController>().getHasStarted()) yield return null;
...
//     bool GameStateIsStable()
//     {
//         // Checks if fall speed of all cubes except currentLetterCube is 0
//         return true;
//     }
...
//             if(stateScanCount == 0)
//             {
//                 // Scan the and keep track of words here 
//             }
//             if(currentLetterCube.GetComponent<LetterCubeController>().getFallSpeed() == 0)
//                 InstantiateLetterCube();
